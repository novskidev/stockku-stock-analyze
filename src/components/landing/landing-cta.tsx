    ...
    <section id="cta" className="relative px-6 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-[960px] text-center">
        ...
        <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
          <button className="h-14 rounded-xl bg-primary px-10 text-lg font-bold text-primary-foreground shadow-[0_0_20px_color-mix(in_srgb,var(--primary)_35%,transparent)] transition-all hover:-translate-y-1 hover:bg-primary/90">
            Get Market Access
          </button>
          <button className="h-14 rounded-xl border border-border/70 bg-secondary px-10 text-lg font-bold text-foreground transition-all hover:border-foreground/70 hover:bg-foreground/5">
            View Pricing
          </button>
        </div>
